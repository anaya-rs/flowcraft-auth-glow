      ...
      <nav className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-gray-900">FlowCraft AI</span>
          </div>
          <Link to="/login">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" className="px-8 py-3 rounded-xl font-semibold text-lg border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all">
              Learn More
            </Button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          <div className="glass-card p-6 rounded-2xl text-center hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600">Blazing fast AI processing with real-time results and instant feedback.</p>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl text-center hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600">Seamless collaboration tools for teams of any size, anywhere in the world.</p>
          </div>
        </div>
      </div>
    </div>
